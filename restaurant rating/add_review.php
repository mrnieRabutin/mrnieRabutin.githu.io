...
<h2>Post Your Review</h2>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?booking_id=' . $booking_id; ?>">
        <div>
            ...
            <input type="text" id="name" name="name" value="<?php echo isset($_SESSION['email']) ? $_SESSION['email'] : ''; ?>" required>
            <!-- Automatically fill the username field with the logged-in user's email -->
        </div>
        <div>
